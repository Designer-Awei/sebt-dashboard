...
**当前版本**: v6.1 - ESP32-C3 + BLE + WebSocket Bridge架构 + 自动化测试功能
...
- 🔧 精简日志内容：移除重复和琐碎信息
- 🔧 优化数据处理流程：提高数据更新实时性
- 🐛 修复多个UI和功能bug（详见CHANGELOG.md）

### v6.0 (2025-01)
- ✅ 确认COM9（传出端口）可以接收数据，更新测试脚本优先使用COM9
- ✅ 精简文档，合并所有MD文件到README
- ✅ 添加项目背景板块
